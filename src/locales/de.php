...
return [
  ...
  'rp_secci_header' => 'EU-Standardinformationen für Verbraucherkredite',
  'rp_secci_choose_delivery_method' => 'W&auml;hlen Sie vor Abschluss Ihrer Bestellung, wie Sie diese Informationen erhalten m&ouml;chten.',
  'rp_secci_learn_more' => 'Mehr erfahren',
  'rp_secci_description' => 'Die EU-Verbraucherkreditrichtlinien haben sich ge&auml;ndert und erfordern nun zus&auml;tzliche Informationen f&uuml;r Zahlung in 3 Raten und bestimmte Rechnungsk&auml;ufe. Diese Informationen helfen Ihnen, die wesentlichen Kreditkonditionen vor Abschluss Ihres Kaufs zu verstehen. Unser Zahlungspartner Ratepay verwendet Ihre E-Mail-Adresse ausschlie&szlig;lich zum Versand dieser Informationen &uuml;ber einen externen E-Mail-Dienstleister.',
  'rp_secci_get_by_email' => 'Per E-Mail erhalten',
  'rp_secci_download_pdf' => 'PDF herunterladen',
  'rp_secci_choose_email' => 'Wir haben die erforderlichen EU-Standardinformationen für Verbraucherkredite gesendet an',
  'rp_secci_payment_methods' => 'Zahlungsart',
  'rp_secci_choose_payment_method' => 'Wenn Sie Rechnungskauf oder Zahle in 3 Raten w&auml;hlen, werden diese Informationen automatisch an',
  'rp_secci_choose_payment_method2' => 'gesendet.',
  'rp_secci_change_email' => 'E-Mail &auml;ndern',
  'rp_secci_save' => 'Speichern',
  'rp_secci_method_invoice' => 'Ratepay Rechnung',
  'rp_secci_method_invoice_desc' => 'In 30 Tagen bezahlen.',
  'rp_secci_method_paypal_desc' => 'Sie werden zu PayPal weitergeleitet.',
  'rp_secci_method_cod' => 'Nachnahme',
  'rp_secci_method_cod_desc' => 'Zahlung bei Erhalt der Ware.',
  'rp_secci_method_installment' => 'Ratepay Zahle in 3 Raten',
  'rp_secci_method_installment_desc' => 'In 3 monatlichen Raten bezahlen.',
  'rp_secci_method_installment_desc2' => '(Ratenrechner hier)',
];
